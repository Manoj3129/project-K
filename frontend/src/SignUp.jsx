        ...
        <div className="flex items-center flex-col mt-10 gap-5">
            ...
            <form className="flex flex-col border-1 border-black w-1/3 p-7 items-center gap-5 mb-5">
                ...
                <div className="w-[90%] flex flex-col gap-2">
                    ...
                    </input><KeyRound className="text-blue-500 top-4 gap-3" />
                </div>
                <div className="w-[90%] flex flex-col gap-2">
                ...
                <Link to="/SignUp" className="w-[90%] text-center bg-purple-500 py-4 text-white rounded xl font-semibold flex justify-center gap-5 ">  <CircleUser /><p>Create Account</p></Link>
